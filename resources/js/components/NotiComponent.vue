<template>
  <div>
    <p
      class="block text-default py-2 px-4 no-underline text-md leading-loose ml-1 my-1 hover:bg-gray-200"
      v-if="realnoti == false"
    >No notification</p>
    <div v-for="noti in notifications">
      <a
        class="block text-default py-2 px-4 no-underline text-md leading-loose ml-1 my-1 hover:bg-gray-200 border-b border-gray-400"
        :href="'/notifications'"
