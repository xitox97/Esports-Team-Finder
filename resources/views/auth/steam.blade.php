...
@endphp
    <div id="app" class="flex font-sans min-h-screen">
            ...
            <sidebar-component v-bind:is-open="isOpen">
                <a
                class="text-lg font-semibold mb-10 mt-12 ml-16 text-purple-400 cursor-not-allowed"
              >
              ...
              <a
                ...
                class="text-lg font-semibold mb-10 ml-16 cursor-pointer text-purple-400 cursor-not-allowed"
              >
              ...
              <a
                ...
                class="text-lg font-semibold mb-10 ml-16 text-purple-400 cursor-not-allowed"
              >
              ...
              <a class="text-lg font-semibold mb-10 ml-16 text-purple-400 cursor-not-allowed">
                    ...
                    <div class="flex items-center justify-around mr-12">
                        ...
                        <div class="mx-3">
                            ...
                            right-0 text-center w-auto">
                                ...
                                text-md leading-loose ml-1 my-1 hover:bg-gray-200">
                                    No notification</p>
                                    <a  class="cursor-not-allowed block font-bold hover:bg-gray-200 leading-loose ml-1 my-1 no-underline px-4 py-2 text-default text-md">
                                        See All Notifications</a>
                        ...
                        <div class="mt-16">
                            <div v-show="opened" id="dropdown" class="absolute  rounded shadow right-0  bg-white w-1/12">
                                    <a  class="cursor-not-allowed block text-default py-2 px-4 no-underline hover:underline text-md leading-loose ml-1 my-1 hover:bg-gray-200">Setting</a>
                ...
                <section id="content-div" class="bg-gray-200 h-full pb-20">
                        <section id="breadcrumb" class="ml-4 pt-2">
                            ...
                            <div class="container ml-20 mt-12">
                                ...
                                <div class="bg-white shadow-lg w-8/12 flex">
                                    <div class="w-3/12">
                                        <img src="{{ URL::to('/') }}/img/steam-icon.png" class="">
                                    </div>
                                    <div class="ml-6 bg-white flex flex-col items-start justify-center mb-10">
                                        <p class="text-2xl font-bold text-indigo-800">Steam</p>
                                        <p class=" text-xl font-semibold text-gray-800">You need to connect to steam before you can proceed.</p>
                                    </div>
